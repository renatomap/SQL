...
INSERT INTO tbSalaFilme(dataFilme, horario) VALUES ('2022-05-20', '18:00:00'), ('2022-06-20', '20:00:00'), ('2022-07-20', '21:00:00');
INSERT INTO tbPremio(nomePremio, anoPremiacao) VALUES ('mtv movie award', 2013), ('oscar efeito visual', 1994), ('urso de ouro', 1988);
...
-- 06 
UPDATE tbSalaFilme SET numeroSala = 1 WHERE numeroSala = 3 AND dataFilme = '2022-05-10';
...
-- 15 
SELECT tbSala.descricaoSala, tbFilme.catFilme, tbFilme.nomeFilme FROM tbSala, tbFilme, tbSalaFilme, tbDiretor
WHERE tbDiretor.nomeDiretor = 'steven spielberg' 
AND tbFilme.codDiretor = tbDiretor.codDiretor
AND tbFilme.codFilme = tbSalaFilme.codFilme
AND tbSala.numeroSala = tbSalaFilme.numeroSala;
